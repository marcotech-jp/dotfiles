# Generated by Powerlevel10k configuration wizard on 2026-06-22 at 21:50 JST.
...
() {
  ...
  function my_git_formatter() {
    ...
    # Use 256-color indices (16+) to avoid terminal theme remapping of ANSI 0-15.
    local       meta='%F{250}' # light grey foreground
    local      clean='%F{232}' # near-black foreground (fixed, not theme-remappable)
    local   modified='%F{232}' # near-black foreground
    local  untracked='%F{232}' # near-black foreground
    local conflicted='%F{160}' # red foreground
